# Instruções locais — Desktop offline

Estas regras se aplicam a `apps/desktop/` e descendentes.
...
# OBJETOS LOCAIS
Mapeie ownership e contrato de Tauri antes de alterar.
Não duplique Tauri se existir implementação compartilhada.
Inclua teste e documentação para mudança em Tauri.
Verifique impacto de segurança, dados e operação em Tauri.
Mapeie ownership e contrato de SQLite local antes de alterar.
Não duplique SQLite local se existir implementação compartilhada.
Inclua teste e documentação para mudança em SQLite local.
Verifique impacto de segurança, dados e operação em SQLite local.
Mapeie ownership e contrato de outbox local antes de alterar.
Não duplique outbox local se existir implementação compartilhada.
Inclua teste e documentação para mudança em outbox local.
Verifique impacto de segurança, dados e operação em outbox local.
Mapeie ownership e contrato de sincronização antes de alterar.
Não duplique sincronização se existir implementação compartilhada.
Inclua teste e documentação para mudança em sincronização.
Verifique impacto de segurança, dados e operação em sincronização.
Mapeie ownership e contrato de conflitos antes de alterar.
Não duplique conflitos se existir implementação compartilhada.
Inclua teste e documentação para mudança em conflitos.
Verifique impacto de segurança, dados e operação em conflitos.
Mapeie ownership e contrato de segredos locais antes de alterar.
Não duplique segredos locais se existir implementação compartilhada.
Inclua teste e documentação para mudança em segredos locais.
Verifique impacto de segurança, dados e operação em segredos locais.
...
Local-1. Preserve compatibilidade de Tauri.
Local-1. Não altere Tauri fora do slice.
Local-1. Registre evidência de Tauri.
Local-1. Revise performance e falha de Tauri.
Local-1. Documente rollback de Tauri.
Local-2. Preserve compatibilidade de SQLite local.
Local-2. Não altere SQLite local fora do slice.
Local-2. Registre evidência de SQLite local.
Local-2. Revise performance e falha de SQLite local.
Local-2. Documente rollback de SQLite local.
Local-3. Preserve compatibilidade de outbox local.
Local-3. Não altere outbox local fora do slice.
Local-3. Registre evidência de outbox local.
Local-3. Revise performance e falha de outbox local.
Local-3. Documente rollback de outbox local.
Local-4. Preserve compatibilidade de sincronização.
Local-4. Não altere sincronização fora do slice.
Local-4. Registre evidência de sincronização.
Local-4. Revise performance e falha de sincronização.
Local-4. Documente rollback de sincronização.
Local-5. Preserve compatibilidade de conflitos.
Local-5. Não altere conflitos fora do slice.
Local-5. Registre evidência de conflitos.
Local-5. Revise performance e falha de conflitos.
Local-5. Documente rollback de conflitos.
Local-6. Preserve compatibilidade de segredos locais.
Local-6. Não altere segredos locais fora do slice.
Local-6. Registre evidência de segredos locais.
Local-6. Revise performance e falha de segredos locais.
Local-6. Documente rollback de segredos locais.
