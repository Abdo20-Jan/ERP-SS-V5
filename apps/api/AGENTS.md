# Instruções locais — API e aplicação

Estas regras se aplicam a `apps/api/` e descendentes.

# AGENTES RESPONSÁVEIS
Acione `api_integration` para mudanças relevantes neste diretório.
Acione `domain_model` para mudanças relevantes neste diretório.
Acione `security` para mudanças relevantes neste diretório.

# OBJETOS LOCAIS
Mapeie ownership e contrato de controllers antes de alterar.
Não duplique controllers se existir implementação compartilhada.
Inclua teste e documentação para mudança em controllers.
Verifique impacto de segurança, dados e operação em controllers.
Mapeie ownership e contrato de application services antes de alterar.
Não duplique application services se existir implementação compartilhada.
Inclua teste e documentação para mudança em application services.
Verifique impacto de segurança, dados e operação em application services.
Mapeie ownership e contrato de autorização antes de alterar.
Não duplique autorização se existir implementação compartilhada.
Inclua teste e documentação para mudança em autorização.
Verifique impacto de segurança, dados e operação em autorização.
Mapeie ownership e contrato de OpenAPI antes de alterar.
Não duplique OpenAPI se existir implementação compartilhada.
Inclua teste e documentação para mudança em OpenAPI.
Verifique impacto de segurança, dados e operação em OpenAPI.
Mapeie ownership e contrato de transações antes de alterar.
Não duplique transações se existir implementação compartilhada.
Inclua teste e documentação para mudança em transações.
Verifique impacto de segurança, dados e operação em transações.
Mapeie ownership e contrato de erros antes de alterar.
Não duplique erros se existir implementação compartilhada.
Inclua teste e documentação para mudança em erros.
Verifique impacto de segurança, dados e operação em erros.
...
Local-1. Preserve compatibilidade de controllers.
Local-1. Não altere controllers fora do slice.
Local-1. Registre evidência de controllers.
Local-1. Revise performance e falha de controllers.
Local-1. Documente rollback de controllers.
Local-2. Preserve compatibilidade de application services.
Local-2. Não altere application services fora do slice.
Local-2. Registre evidência de application services.
Local-2. Revise performance e falha de application services.
Local-2. Documente rollback de application services.
Local-3. Preserve compatibilidade de autorização.
Local-3. Não altere autorização fora do slice.
Local-3. Registre evidência de autorização.
Local-3. Revise performance e falha de autorização.
Local-3. Documente rollback de autorização.
Local-4. Preserve compatibilidade de OpenAPI.
Local-4. Não altere OpenAPI fora do slice.
Local-4. Registre evidência de OpenAPI.
Local-4. Revise performance e falha de OpenAPI.
Local-4. Documente rollback de OpenAPI.
Local-5. Preserve compatibilidade de transações.
Local-5. Não altere transações fora do slice.
Local-5. Registre evidência de transações.
Local-5. Revise performance e falha de transações.
Local-5. Documente rollback de transações.
Local-6. Preserve compatibilidade de erros.
Local-6. Não altere erros fora do slice.
Local-6. Registre evidência de erros.
Local-6. Revise performance e falha de erros.
Local-6. Documente rollback de erros.
