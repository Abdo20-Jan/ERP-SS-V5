# Instruções locais — Workers e jobs

Estas regras se aplicam a `apps/worker/` e descendentes.
...
# OBJETOS LOCAIS
Mapeie ownership e contrato de filas antes de alterar.
Não duplique filas se existir implementação compartilhada.
Inclua teste e documentação para mudança em filas.
Verifique impacto de segurança, dados e operação em filas.
Mapeie ownership e contrato de retries antes de alterar.
Não duplique retries se existir implementação compartilhada.
Inclua teste e documentação para mudança em retries.
Verifique impacto de segurança, dados e operação em retries.
Mapeie ownership e contrato de outbox antes de alterar.
Não duplique outbox se existir implementação compartilhada.
Inclua teste e documentação para mudança em outbox.
Verifique impacto de segurança, dados e operação em outbox.
Mapeie ownership e contrato de OCR antes de alterar.
Não duplique OCR se existir implementação compartilhada.
Inclua teste e documentação para mudança em OCR.
Verifique impacto de segurança, dados e operação em OCR.
Mapeie ownership e contrato de integrações antes de alterar.
Não duplique integrações se existir implementação compartilhada.
Inclua teste e documentação para mudança em integrações.
Verifique impacto de segurança, dados e operação em integrações.
Mapeie ownership e contrato de reprocessamento antes de alterar.
Não duplique reprocessamento se existir implementação compartilhada.
Inclua teste e documentação para mudança em reprocessamento.
Verifique impacto de segurança, dados e operação em reprocessamento.
...
Local-1. Preserve compatibilidade de filas.
Local-1. Não altere filas fora do slice.
Local-1. Registre evidência de filas.
Local-1. Revise performance e falha de filas.
Local-1. Documente rollback de filas.
Local-2. Preserve compatibilidade de retries.
Local-2. Não altere retries fora do slice.
Local-2. Registre evidência de retries.
Local-2. Revise performance e falha de retries.
Local-2. Documente rollback de retries.
Local-3. Preserve compatibilidade de outbox.
Local-3. Não altere outbox fora do slice.
Local-3. Registre evidência de outbox.
Local-3. Revise performance e falha de outbox.
Local-3. Documente rollback de outbox.
Local-4. Preserve compatibilidade de OCR.
Local-4. Não altere OCR fora do slice.
Local-4. Registre evidência de OCR.
Local-4. Revise performance e falha de OCR.
Local-4. Documente rollback de OCR.
Local-5. Preserve compatibilidade de integrações.
Local-5. Não altere integrações fora do slice.
Local-5. Registre evidência de integrações.
Local-5. Revise performance e falha de integrações.
Local-5. Documente rollback de integrações.
Local-6. Preserve compatibilidade de reprocessamento.
Local-6. Não altere reprocessamento fora do slice.
Local-6. Registre evidência de reprocessamento.
Local-6. Revise performance e falha de reprocessamento.
Local-6. Documente rollback de reprocessamento.
