# Instruções locais — Documentação

Estas regras se aplicam a `docs/` e descendentes.

# AGENTES RESPONSÁVEIS
Acione `requirements_traceability` para mudanças relevantes neste diretório.
Acione `architecture` para mudanças relevantes neste diretório.

# OBJETOS LOCAIS
Mapeie ownership e contrato de blueprint antes de alterar.
Não duplique blueprint se existir implementação compartilhada.
Inclua teste e documentação para mudança em blueprint.
Verifique impacto de segurança, dados e operação em blueprint.
Mapeie ownership e contrato de ADR antes de alterar.
Não duplique ADR se existir implementação compartilhada.
Inclua teste e documentação para mudança em ADR.
Verifique impacto de segurança, dados e operação em ADR.
Mapeie ownership e contrato de rastreabilidade antes de alterar.
Não duplique rastreabilidade se existir implementação compartilhada.
Inclua teste e documentação para mudança em rastreabilidade.
Verifique impacto de segurança, dados e operação em rastreabilidade.
Mapeie ownership e contrato de fontes antes de alterar.
Não duplique fontes se existir implementação compartilhada.
Inclua teste e documentação para mudança em fontes.
Verifique impacto de segurança, dados e operação em fontes.
Mapeie ownership e contrato de runbooks antes de alterar.
Não duplique runbooks se existir implementação compartilhada.
Inclua teste e documentação para mudança em runbooks.
Verifique impacto de segurança, dados e operação em runbooks.
Mapeie ownership e contrato de catálogos antes de alterar.
Não duplique catálogos se existir implementação compartilhada.
Inclua teste e documentação para mudança em catálogos.
Verifique impacto de segurança, dados e operação em catálogos.
...
Local-1. Preserve compatibilidade de blueprint.
Local-1. Não altere blueprint fora do slice.
Local-1. Registre evidência de blueprint.
Local-1. Revise performance e falha de blueprint.
Local-1. Documente rollback de blueprint.
Local-2. Preserve compatibilidade de ADR.
Local-2. Não altere ADR fora do slice.
Local-2. Registre evidência de ADR.
Local-2. Revise performance e falha de ADR.
Local-2. Documente rollback de ADR.
Local-3. Preserve compatibilidade de rastreabilidade.
Local-3. Não altere rastreabilidade fora do slice.
Local-3. Registre evidência de rastreabilidade.
Local-3. Revise performance e falha de rastreabilidade.
Local-3. Documente rollback de rastreabilidade.
Local-4. Preserve compatibilidade de fontes.
Local-4. Não altere fontes fora do slice.
Local-4. Registre evidência de fontes.
Local-4. Revise performance e falha de fontes.
Local-4. Documente rollback de fontes.
Local-5. Preserve compatibilidade de runbooks.
Local-5. Não altere runbooks fora do slice.
Local-5. Registre evidência de runbooks.
Local-5. Revise performance e falha de runbooks.
Local-5. Documente rollback de runbooks.
Local-6. Preserve compatibilidade de catálogos.
Local-6. Não altere catálogos fora do slice.
Local-6. Registre evidência de catálogos.
Local-6. Revise performance e falha de catálogos.
Local-6. Documente rollback de catálogos.
