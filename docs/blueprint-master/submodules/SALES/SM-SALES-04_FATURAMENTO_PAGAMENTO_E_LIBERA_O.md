# SM-SALES-04 — Faturamento, pagamento e liberação

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Comercial
**PR lógico:** `PR-SALES-04`

## Resultado esperado

Entregar faturamento, pagamento e liberação de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Solicitar emissão fiscal ao módulo Fiscal/SI Factura.
2. Controlar fatura, notas, impostos, vencimento e situação da autorização.
3. Registrar comprovante e aguardar crédito bancário efetivo.
4. Liberar mercadoria somente após recebimento ou pagamento da financeira.
5. Tratar pagamento parcial, crédito em conta e múltiplos meios.
6. Emitir comprovante interno de contingência quando aplicável.
7. Gerar gate de liberação auditável.
8. Integrar faturamento, tesouraria, estoque e contabilidade.
...
- Controller e 10 slices: `docs/requirements/pr-programs/SALES/PR-SALES-04/`
