# SM-QA-02 — Migração e reconciliação
...
Entregar migração e reconciliação de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Definir inventário de dados mestres, saldos e documentos a migrar.
2. Criar layouts, regras de transformação e validação.
3. Importar em batches idempotentes com resultado por registro.
4. Manter rejeitados, correções e reprocessamento.
5. Reconciliar contagem, valores, saldos e amostras.
6. Gerar propostas de lançamento a partir de extratos/documentos sem postar automaticamente.
7. Preservar origem, arquivo, linha e hash.
8. Emitir termo de aceite da migração.
...
- Controller e 10 slices: `docs/requirements/pr-programs/QA/PR-QA-02/`
