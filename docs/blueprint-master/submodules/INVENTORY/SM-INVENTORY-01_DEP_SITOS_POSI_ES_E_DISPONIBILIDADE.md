# SM-INVENTORY-01 — Depósitos, posições e disponibilidade

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Estoque
**PR lógico:** `PR-INVENTORY-01`

## Resultado esperado

Entregar depósitos, posições e disponibilidade de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Manter depósitos nacionais, fiscais, terceirizados e futuros depósitos próprios.
2. Controlar código, tipo, endereço, zonas e capacidade.
3. Manter hierarquia Zona → Rua → Rack → Nível → Posição.
4. Ativar ou desativar níveis de endereçamento por depósito.
5. Controlar locais virtuais como trânsito e porto.
6. Consultar saldo físico, disponível, reservado e bloqueado.
7. Calcular available-to-promise por SKU e depósito.
8. Exibir mapa e filtros por posição, despacho, contêiner e status.
...
- Controller e 10 slices: `docs/requirements/pr-programs/INVENTORY/PR-INVENTORY-01/`
