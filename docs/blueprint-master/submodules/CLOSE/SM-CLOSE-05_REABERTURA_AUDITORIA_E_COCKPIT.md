# SM-CLOSE-05 — Reabertura, auditoria e cockpit

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Fechamento contábil transversal
**PR lógico:** `PR-CLOSE-05`

## Resultado esperado

Entregar reabertura, auditoria e cockpit de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Aprovar fechamento do período e bloquear postagens comuns.
2. Reabrir período somente com permissão, motivo e aprovador.
3. Registrar toda alteração feita após reabertura.
4. Comparar demonstrações antes e depois da reabertura.
5. Manter evidências, assinatura e log imutável.
6. Exibir cockpit com progresso, riscos, variações e tarefas críticas.
7. Alertar lançamento tardio e subledger fora de reconciliação.
8. Encerrar novamente o período com nova versão do pacote.
...
- Controller e 10 slices: `docs/requirements/pr-programs/CLOSE/PR-CLOSE-05/`
