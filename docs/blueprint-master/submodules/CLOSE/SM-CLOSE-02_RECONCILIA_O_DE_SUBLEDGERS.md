# SM-CLOSE-02 — Reconciliação de subledgers

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Fechamento contábil transversal
**PR lógico:** `PR-CLOSE-02`

## Resultado esperado

Entregar reconciliação de subledgers de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Reconciliar COMEX, landed cost, fiscal, estoque, tesouraria, comercial e compras com o GL.
2. Definir regras e chaves de correspondência por subledger.
3. Comparar saldos, movimentos e documentos.
4. Classificar diferença como timing, erro, pendência ou ajuste.
5. Criar item de reconciliação, responsável e prazo.
6. Exigir explicação ou ajuste para saldo material.
7. Permitir drill-down até documento e evento operacional.
8. Emitir evidência e assinatura da reconciliação.
...
- Controller e 10 slices: `docs/requirements/pr-programs/CLOSE/PR-CLOSE-02/`
