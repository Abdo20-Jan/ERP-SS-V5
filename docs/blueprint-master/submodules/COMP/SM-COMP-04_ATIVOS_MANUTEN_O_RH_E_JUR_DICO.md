# SM-COMP-04 — Ativos, manutenção, RH e jurídico

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Módulos complementares
**PR lógico:** `PR-COMP-04`

## Resultado esperado

Entregar ativos, manutenção, rh e jurídico de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Manter cadastro básico de ativos, localização, responsável e valor.
2. Planejar e registrar manutenção preventiva e corretiva.
3. Manter perfil de colaborador, setor, cargo, acesso e documentos mínimos.
4. Integrar admissão/desligamento com provisionamento de usuário.
5. Manter contratos, procurações, documentos legais e vencimentos.
6. Criar alertas de renovação, obrigação e risco jurídico.
7. Controlar anexos, responsável, status e aprovação.
8. Permitir ativação gradual por feature flag.
...
- Controller e 10 slices: `docs/requirements/pr-programs/COMP/PR-COMP-04/`
