# SM-COMP-02 — Garantia, reclamação e devolução

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Módulos complementares
**PR lógico:** `PR-COMP-02`

## Resultado esperado

Entregar garantia, reclamação e devolução de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Abrir reclamação vinculada a cliente, venda, SKU e despacho.
2. Registrar sintomas, fotos, documentos, quantidade e data.
3. Executar triagem, inspeção e decisão de elegibilidade.
4. Aprovar, rejeitar ou solicitar informação adicional.
5. Gerar devolução, reposição, crédito ou outra resolução.
6. Gerar impacto fiscal, estoque e financeiro somente após decisão.
7. Controlar SLA, responsável, custo e causa raiz.
8. Preservar histórico e evidências do caso.
...
- Controller e 10 slices: `docs/requirements/pr-programs/COMP/PR-COMP-02/`
