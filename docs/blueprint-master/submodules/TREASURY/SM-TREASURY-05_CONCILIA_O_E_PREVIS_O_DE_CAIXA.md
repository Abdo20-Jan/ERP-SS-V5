# SM-TREASURY-05 — Conciliação e previsão de caixa

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Tesouraria
**PR lógico:** `PR-TREASURY-05`

## Resultado esperado

Entregar conciliação e previsão de caixa de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Importar extrato e sugerir correspondência com pagamentos e recebimentos.
2. Executar matching por valor, data, contraparte, referência e documento.
3. Permitir revisão manual preservando a sugestão original.
4. Controlar itens não conciliados, diferenças e pendências.
5. Gerar previsão de caixa por vencimento, pedido, importação e cenário.
6. Produzir visão diária, semanal e mensal.
7. Comparar realizado versus previsto e explicar variações.
8. Emitir alertas de saldo insuficiente, concentração e vencimento.
...
- Controller e 10 slices: `docs/requirements/pr-programs/TREASURY/PR-TREASURY-05/`
