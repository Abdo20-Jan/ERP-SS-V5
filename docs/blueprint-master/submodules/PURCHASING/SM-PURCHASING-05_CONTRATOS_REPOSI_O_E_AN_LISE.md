# SM-PURCHASING-05 — Contratos, reposição e análise

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Compras
**PR lógico:** `PR-PURCHASING-05`

## Resultado esperado

Entregar contratos, reposição e análise de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Manter contratos de fornecimento e serviço com vigência e anexos.
2. Controlar preços, reajustes, limites, consumo e vencimentos.
3. Gerar alertas de renovação e obrigação contratual.
4. Sugerir reposição por estoque, consumo ou demanda configurada.
5. Analisar compras por fornecedor, categoria, centro de custo e período.
6. Comparar preço contratado, pedido e faturado.
7. Medir lead time, cumprimento e variação de custo.
8. Gerar base para negociação e orçamento.
...
- Controller e 10 slices: `docs/requirements/pr-programs/PURCHASING/PR-PURCHASING-05/`
