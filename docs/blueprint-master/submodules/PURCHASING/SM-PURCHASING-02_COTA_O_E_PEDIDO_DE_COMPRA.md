# SM-PURCHASING-02 — Cotação e pedido de compra

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Compras
**PR lógico:** `PR-PURCHASING-02`

## Resultado esperado

Entregar cotação e pedido de compra de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Solicitar e registrar propostas de múltiplos fornecedores.
2. Comparar preço, prazo, impostos, frete, condição e moeda.
3. Selecionar proposta com justificativa quando não for a menor.
4. Criar pedido de compra e linhas por item/serviço.
5. Controlar aprovação, envio, aceite e alteração do pedido.
6. Manter saldo, vigência, datas e condições do pedido.
7. Importar linhas em massa e copiar pedidos recorrentes.
8. Vincular fornecedor e histórico de dados bancários.
...
- Controller e 10 slices: `docs/requirements/pr-programs/PURCHASING/PR-PURCHASING-02/`
