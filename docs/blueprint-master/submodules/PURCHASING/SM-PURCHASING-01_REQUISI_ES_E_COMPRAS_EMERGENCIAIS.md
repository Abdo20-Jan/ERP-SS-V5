# SM-PURCHASING-01 — Requisições e compras emergenciais

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Compras
**PR lógico:** `PR-PURCHASING-01`

## Resultado esperado

Entregar requisições e compras emergenciais de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Criar requisição de compra por área, categoria, centro de custo e necessidade.
2. Classificar bens, serviços, consumo, ativo ou despesa.
3. Definir urgência, justificativa, quantidade, orçamento e data necessária.
4. Executar workflow de aprovação por valor e categoria.
5. Permitir compra emergencial com regularização posterior e trilha completa.
6. Evitar requisições duplicadas da mesma necessidade.
7. Converter requisição aprovada em cotação ou pedido.
8. Exibir fila de pendências e SLA da solicitação.
...
- Controller e 10 slices: `docs/requirements/pr-programs/PURCHASING/PR-PURCHASING-01/`
