# SM-PURCHASING-04 — Fatura e contas a pagar

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Compras
**PR lógico:** `PR-PURCHASING-04`

## Resultado esperado

Entregar fatura e contas a pagar de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Capturar fatura por OCR, upload, e-mail ou entrada manual.
2. Registrar cada item líquido e tributos em linhas separadas.
3. Executar conferência pedido × recebimento × fatura quando aplicável.
4. Classificar conta contábil, centro de custo, imposto e vencimento.
5. Tratar fatura sem pedido ou compra emergencial com aprovação.
6. Gerar obrigação de contas a pagar.
7. Permitir pagamento por terceiro ou a contraparte diferente.
8. Manter vínculo integral entre fatura, obrigação, pagamento e documento.
...
- Controller e 10 slices: `docs/requirements/pr-programs/PURCHASING/PR-PURCHASING-04/`
