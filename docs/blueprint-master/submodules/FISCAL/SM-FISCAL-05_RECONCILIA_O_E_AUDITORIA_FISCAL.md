# SM-FISCAL-05 — Reconciliação e auditoria fiscal

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Fiscal
**PR lógico:** `PR-FISCAL-05`

## Resultado esperado

Entregar reconciliação e auditoria fiscal de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Reconciliar documentos fiscais com vendas, compras, tesouraria e contabilidade.
2. Comparar autorização externa com registro interno.
3. Localizar documentos faltantes, duplicados, rejeitados ou pendentes.
4. Permitir drill-down da apuração até documento e linha.
5. Controlar trilha de alterações de regra e vigência.
6. Gerar evidências para auditoria e contador.
7. Registrar ajustes e retificações sem apagar o período original.
8. Emitir painel de riscos, obrigações e inconsistências fiscais.
...
- Controller e 10 slices: `docs/requirements/pr-programs/FISCAL/PR-FISCAL-05/`
