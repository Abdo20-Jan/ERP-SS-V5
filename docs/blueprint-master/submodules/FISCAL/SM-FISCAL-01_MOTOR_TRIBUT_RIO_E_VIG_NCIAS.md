# SM-FISCAL-01 — Motor tributário e vigências

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Fiscal
**PR lógico:** `PR-FISCAL-01`

## Resultado esperado

Entregar motor tributário e vigências de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Manter regras tributárias versionadas por data de vigência.
2. Determinar IVA, IIBB, percepções, retenções e demais tributos por operação.
3. Considerar jurisdição, província, condição fiscal do cliente, tipo de documento e item.
4. Validar CUIT e condição de IVA.
5. Importar e aplicar padrón COMARB/AGIP ou fonte configurada.
6. Simular cálculo antes da emissão.
7. Explicar a regra aplicada, base, alíquota, fonte e exceção.
8. Preservar histórico quando uma alíquota ou condição mudar.
...
- Controller e 10 slices: `docs/requirements/pr-programs/FISCAL/PR-FISCAL-01/`
