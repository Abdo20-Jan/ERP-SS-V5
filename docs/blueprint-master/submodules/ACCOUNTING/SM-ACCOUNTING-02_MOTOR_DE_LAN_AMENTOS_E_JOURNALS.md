# SM-ACCOUNTING-02 — Motor de lançamentos e journals

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** Contábil — fundação
**PR lógico:** `PR-ACCOUNTING-02`

## Resultado esperado

Entregar motor de lançamentos e journals de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Receber eventos dos módulos e gerar proposta contábil.
2. Aplicar regra de débito, crédito, conta, dimensão, moeda e histórico.
3. Criar lançamentos manuais com dupla partida obrigatória.
4. Validar débito igual a crédito antes da postagem.
5. Aprovar, postar, reverter, estornar e reapresentar lançamentos.
6. Impedir duplicidade por idempotency key do evento de origem.
7. Manter vínculo até documento, workflow e usuário de origem.
8. Executar lançamentos em lote com validação por linha.
...
- Controller e 10 slices: `docs/requirements/pr-programs/ACCOUNTING/PR-ACCOUNTING-02/`
