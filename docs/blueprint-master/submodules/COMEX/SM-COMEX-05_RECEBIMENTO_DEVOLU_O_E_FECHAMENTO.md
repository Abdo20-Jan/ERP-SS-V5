# SM-COMEX-05 — Recebimento, devolução e fechamento

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** COMEX
**PR lógico:** `PR-COMEX-05`

## Resultado esperado

Entregar recebimento, devolução e fechamento de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Registrar chegada, descarga, desconsolidação e confirmação do depósito.
2. Conferir quantidade recebida contra packing list, despacho e contêiner.
3. Tratar faltas, sobras, avarias, mercadoria bloqueada e ocorrências com operador.
4. Gerar entrada em estoque por SKU, despacho, contêiner e camada de custo.
5. Controlar prazo e comprovante de devolução do contêiner.
6. Registrar gastos finais e custos tardios vinculados à importação.
7. Validar checklist de encerramento operacional, documental, financeiro e aduaneiro.
8. Reabrir a importação com permissão, motivo e histórico completo.
...
- Controller e 10 slices: `docs/requirements/pr-programs/COMEX/PR-COMEX-05/`
