# SM-COMEX-04 — Documentos, OCR, ocorrências e prazos

**Status:** `APPROVED_FOR_PLANNING_AND_EXECUTION`
**Módulo:** COMEX
**PR lógico:** `PR-COMEX-04`

## Resultado esperado

Entregar documentos, ocr, ocorrências e prazos de forma integrada, auditável, idempotente e otimizada para operação diária.

## Funções aprovadas

1. Receber documentos por upload, e-mail, API ou importação em lote.
2. Classificar proforma, invoice, packing list, BL, booking, despacho, comprovantes e faturas de gastos.
3. Extrair campos e itens por OCR com confiança por campo e revisão humana.
4. Associar automaticamente documentos ao pedido, fornecedor, contêiner e despacho.
5. Comparar documentos e abrir divergências por quantidade, valor, SKU, peso ou identificação.
6. Abrir ocorrências, atribuir responsável, prazo, prioridade, evidência e resolução.
7. Controlar vencimentos, ETA, free time, devolução, pagamentos e documentos faltantes.
8. Manter versionamento, trilha de auditoria, busca integral e visualização lado a lado.
...
- Controller e 10 slices: `docs/requirements/pr-programs/COMEX/PR-COMEX-04/`
