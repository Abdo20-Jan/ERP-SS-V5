# Instruções locais — Scripts e automação

Estas regras se aplicam a `scripts/` e descendentes.

# AGENTES RESPONSÁVEIS
Acione `platform_devops` para mudanças relevantes neste diretório.
Acione `security` para mudanças relevantes neste diretório.
Acione `testing_quality` para mudanças relevantes neste diretório.

# OBJETOS LOCAIS
Mapeie ownership e contrato de validação antes de alterar.
Não duplique validação se existir implementação compartilhada.
Inclua teste e documentação para mudança em validação.
Verifique impacto de segurança, dados e operação em validação.
Mapeie ownership e contrato de bootstrap antes de alterar.
Não duplique bootstrap se existir implementação compartilhada.
Inclua teste e documentação para mudança em bootstrap.
Verifique impacto de segurança, dados e operação em bootstrap.
Mapeie ownership e contrato de CI helpers antes de alterar.
Não duplique CI helpers se existir implementação compartilhada.
Inclua teste e documentação para mudança em CI helpers.
Verifique impacto de segurança, dados e operação em CI helpers.
Mapeie ownership e contrato de migração antes de alterar.
Não duplique migração se existir implementação compartilhada.
Inclua teste e documentação para mudança em migração.
Verifique impacto de segurança, dados e operação em migração.
Mapeie ownership e contrato de segurança de shell antes de alterar.
Não duplique segurança de shell se existir implementação compartilhada.
Inclua teste e documentação para mudança em segurança de shell.
Verifique impacto de segurança, dados e operação em segurança de shell.
Mapeie ownership e contrato de portabilidade antes de alterar.
Não duplique portabilidade se existir implementação compartilhada.
Inclua teste e documentação para mudança em portabilidade.
Verifique impacto de segurança, dados e operação em portabilidade.
...
Local-1. Preserve compatibilidade de validação.
Local-1. Não altere validação fora do slice.
Local-1. Registre evidência de validação.
Local-1. Revise performance e falha de validação.
Local-1. Documente rollback de validação.
Local-2. Preserve compatibilidade de bootstrap.
Local-2. Não altere bootstrap fora do slice.
Local-2. Registre evidência de bootstrap.
Local-2. Revise performance e falha de bootstrap.
Local-2. Documente rollback de bootstrap.
Local-3. Preserve compatibilidade de CI helpers.
Local-3. Não altere CI helpers fora do slice.
Local-3. Registre evidência de CI helpers.
Local-3. Revise performance e falha de CI helpers.
Local-3. Documente rollback de CI helpers.
Local-4. Preserve compatibilidade de migração.
Local-4. Não altere migração fora do slice.
Local-4. Registre evidência de migração.
Local-4. Revise performance e falha de migração.
Local-4. Documente rollback de migração.
Local-5. Preserve compatibilidade de segurança de shell.
Local-5. Não altere segurança de shell fora do slice.
Local-5. Registre evidência de segurança de shell.
Local-5. Revise performance e falha de segurança de shell.
Local-5. Documente rollback de segurança de shell.
Local-6. Preserve compatibilidade de portabilidade.
Local-6. Não altere portabilidade fora do slice.
Local-6. Registre evidência de portabilidade.
Local-6. Revise performance e falha de portabilidade.
Local-6. Documente rollback de portabilidade.
