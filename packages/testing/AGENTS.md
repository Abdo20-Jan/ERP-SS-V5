# Instruções locais — Infra de testes

Estas regras se aplicam a `packages/testing/` e descendentes.
...
# OBJETOS LOCAIS
Mapeie ownership e contrato de fixtures antes de alterar.
Não duplique fixtures se existir implementação compartilhada.
Inclua teste e documentação para mudança em fixtures.
Verifique impacto de segurança, dados e operação em fixtures.
Mapeie ownership e contrato de builders antes de alterar.
Não duplique builders se existir implementação compartilhada.
Inclua teste e documentação para mudança em builders.
Verifique impacto de segurança, dados e operação em builders.
Mapeie ownership e contrato de harness antes de alterar.
Não duplique harness se existir implementação compartilhada.
Inclua teste e documentação para mudança em harness.
Verifique impacto de segurança, dados e operação em harness.
Mapeie ownership e contrato de contratos antes de alterar.
Não duplique contratos se existir implementação compartilhada.
Inclua teste e documentação para mudança em contratos.
Verifique impacto de segurança, dados e operação em contratos.
Mapeie ownership e contrato de E2E antes de alterar.
Não duplique E2E se existir implementação compartilhada.
Inclua teste e documentação para mudança em E2E.
Verifique impacto de segurança, dados e operação em E2E.
Mapeie ownership e contrato de evidência antes de alterar.
Não duplique evidência se existir implementação compartilhada.
Inclua teste e documentação para mudança em evidência.
Verifique impacto de segurança, dados e operação em evidência.
...
Local-1. Preserve compatibilidade de fixtures.
Local-1. Não altere fixtures fora do slice.
Local-1. Registre evidência de fixtures.
Local-1. Revise performance e falha de fixtures.
Local-1. Documente rollback de fixtures.
Local-2. Preserve compatibilidade de builders.
Local-2. Não altere builders fora do slice.
Local-2. Registre evidência de builders.
Local-2. Revise performance e falha de builders.
Local-2. Documente rollback de builders.
Local-3. Preserve compatibilidade de harness.
Local-3. Não altere harness fora do slice.
Local-3. Registre evidência de harness.
Local-3. Revise performance e falha de harness.
Local-3. Documente rollback de harness.
Local-4. Preserve compatibilidade de contratos.
Local-4. Não altere contratos fora do slice.
Local-4. Registre evidência de contratos.
Local-4. Revise performance e falha de contratos.
Local-4. Documente rollback de contratos.
Local-5. Preserve compatibilidade de E2E.
Local-5. Não altere E2E fora do slice.
Local-5. Registre evidência de E2E.
Local-5. Revise performance e falha de E2E.
Local-5. Documente rollback de E2E.
Local-6. Preserve compatibilidade de evidência.
Local-6. Não altere evidência fora do slice.
Local-6. Registre evidência de evidência.
Local-6. Revise performance e falha de evidência.
Local-6. Documente rollback de evidência.
