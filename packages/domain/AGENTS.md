# Instruções locais — Domínio

Estas regras se aplicam a `packages/domain/` e descendentes.
...
# OBJETOS LOCAIS
Mapeie ownership e contrato de aggregates antes de alterar.
Não duplique aggregates se existir implementação compartilhada.
Inclua teste e documentação para mudança em aggregates.
Verifique impacto de segurança, dados e operação em aggregates.
Mapeie ownership e contrato de value objects antes de alterar.
Não duplique value objects se existir implementação compartilhada.
Inclua teste e documentação para mudança em value objects.
Verifique impacto de segurança, dados e operação em value objects.
Mapeie ownership e contrato de commands antes de alterar.
Não duplique commands se existir implementação compartilhada.
Inclua teste e documentação para mudança em commands.
Verifique impacto de segurança, dados e operação em commands.
Mapeie ownership e contrato de events antes de alterar.
Não duplique events se existir implementação compartilhada.
Inclua teste e documentação para mudança em events.
Verifique impacto de segurança, dados e operação em events.
Mapeie ownership e contrato de states antes de alterar.
Não duplique states se existir implementação compartilhada.
Inclua teste e documentação para mudança em states.
Verifique impacto de segurança, dados e operação em states.
Mapeie ownership e contrato de policies antes de alterar.
Não duplique policies se existir implementação compartilhada.
Inclua teste e documentação para mudança em policies.
Verifique impacto de segurança, dados e operação em policies.
...
Local-1. Preserve compatibilidade de aggregates.
Local-1. Não altere aggregates fora do slice.
Local-1. Registre evidência de aggregates.
Local-1. Revise performance e falha de aggregates.
Local-1. Documente rollback de aggregates.
Local-2. Preserve compatibilidade de value objects.
Local-2. Não altere value objects fora do slice.
Local-2. Registre evidência de value objects.
Local-2. Revise performance e falha de value objects.
Local-2. Documente rollback de value objects.
Local-3. Preserve compatibilidade de commands.
Local-3. Não altere commands fora do slice.
Local-3. Registre evidência de commands.
Local-3. Revise performance e falha de commands.
Local-3. Documente rollback de commands.
Local-4. Preserve compatibilidade de events.
Local-4. Não altere events fora do slice.
Local-4. Registre evidência de events.
Local-4. Revise performance e falha de events.
Local-4. Documente rollback de events.
Local-5. Preserve compatibilidade de states.
Local-5. Não altere states fora do slice.
Local-5. Registre evidência de states.
Local-5. Revise performance e falha de states.
Local-5. Documente rollback de states.
Local-6. Preserve compatibilidade de policies.
Local-6. Não altere policies fora do slice.
Local-6. Registre evidência de policies.
Local-6. Revise performance e falha de policies.
Local-6. Documente rollback de policies.
