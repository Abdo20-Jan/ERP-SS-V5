# Instruções locais — Observabilidade

Estas regras se aplicam a `packages/observability/` e descendentes.
...
# OBJETOS LOCAIS
Mapeie ownership e contrato de logs antes de alterar.
Não duplique logs se existir implementação compartilhada.
Inclua teste e documentação para mudança em logs.
Verifique impacto de segurança, dados e operação em logs.
Mapeie ownership e contrato de métricas antes de alterar.
Não duplique métricas se existir implementação compartilhada.
Inclua teste e documentação para mudança em métricas.
Verifique impacto de segurança, dados e operação em métricas.
Mapeie ownership e contrato de traces antes de alterar.
Não duplique traces se existir implementação compartilhada.
Inclua teste e documentação para mudança em traces.
Verifique impacto de segurança, dados e operação em traces.
Mapeie ownership e contrato de alertas antes de alterar.
Não duplique alertas se existir implementação compartilhada.
Inclua teste e documentação para mudança em alertas.
Verifique impacto de segurança, dados e operação em alertas.
Mapeie ownership e contrato de redação antes de alterar.
Não duplique redação se existir implementação compartilhada.
Inclua teste e documentação para mudança em redação.
Verifique impacto de segurança, dados e operação em redação.
...
Local-1. Preserve compatibilidade de logs.
Local-1. Não altere logs fora do slice.
Local-1. Registre evidência de logs.
Local-1. Revise performance e falha de logs.
Local-1. Documente rollback de logs.
Local-2. Preserve compatibilidade de métricas.
Local-2. Não altere métricas fora do slice.
Local-2. Registre evidência de métricas.
Local-2. Revise performance e falha de métricas.
Local-2. Documente rollback de métricas.
Local-3. Preserve compatibilidade de traces.
Local-3. Não altere traces fora do slice.
Local-3. Registre evidência de traces.
Local-3. Revise performance e falha de traces.
Local-3. Documente rollback de traces.
Local-4. Preserve compatibilidade de alertas.
Local-4. Não altere alertas fora do slice.
Local-4. Registre evidência de alertas.
Local-4. Revise performance e falha de alertas.
Local-4. Documente rollback de alertas.
Local-5. Preserve compatibilidade de redação.
Local-5. Não altere redação fora do slice.
Local-5. Registre evidência de redação.
Local-5. Revise performance e falha de redação.
Local-5. Documente rollback de redação.
Local-6. Preserve compatibilidade de runbooks.
Local-6. Não altere runbooks fora do slice.
Local-6. Registre evidência de runbooks.
Local-6. Revise performance e falha de runbooks.
Local-6. Documente rollback de runbooks.
