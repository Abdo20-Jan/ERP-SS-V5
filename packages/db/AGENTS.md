# Instruções locais — Persistência

Estas regras se aplicam a `packages/db/` e descendentes.

# AGENTES RESPONSÁVEIS
Acione `database` para mudanças relevantes neste diretório.
Acione `accounting` para mudanças relevantes neste diretório.
Acione `security` para mudanças relevantes neste diretório.

# OBJETOS LOCAIS
Mapeie ownership e contrato de schema antes de alterar.
Não duplique schema se existir implementação compartilhada.
Inclua teste e documentação para mudança em schema.
Verifique impacto de segurança, dados e operação em schema.
Mapeie ownership e contrato de migrations antes de alterar.
Não duplique migrations se existir implementação compartilhada.
Inclua teste e documentação para mudança em migrations.
Verifique impacto de segurança, dados e operação em migrations.
Mapeie ownership e contrato de índices antes de alterar.
Não duplique índices se existir implementação compartilhada.
Inclua teste e documentação para mudança em índices.
Verifique impacto de segurança, dados e operação em índices.
Mapeie ownership e contrato de constraints antes de alterar.
Não duplique constraints se existir implementação compartilhada.
Inclua teste e documentação para mudança em constraints.
Verifique impacto de segurança, dados e operação em constraints.
...
Mapeie ownership e contrato de lineage antes de alterar.
Não duplique lineage se existir implementação compartilhada.
Inclua teste e documentação para mudança em lineage.
Verifique impacto de segurança, dados e operação em lineage.
...
Local-1. Preserve compatibilidade de schema.
Local-1. Não altere schema fora do slice.
Local-1. Registre evidência de schema.
Local-1. Revise performance e falha de schema.
Local-1. Documente rollback de schema.
Local-2. Preserve compatibilidade de migrations.
Local-2. Não altere migrations fora do slice.
Local-2. Registre evidência de migrations.
Local-2. Revise performance e falha de migrations.
Local-2. Documente rollback de migrations.
Local-3. Preserve compatibilidade de índices.
Local-3. Não altere índices fora do slice.
Local-3. Registre evidência de índices.
Local-3. Revise performance e falha de índices.
Local-3. Documente rollback de índices.
Local-4. Preserve compatibilidade de constraints.
Local-4. Não altere constraints fora do slice.
Local-4. Registre evidência de constraints.
Local-4. Revise performance e falha de constraints.
Local-4. Documente rollback de constraints.
...
Local-6. Preserve compatibilidade de lineage.
Local-6. Não altere lineage fora do slice.
Local-6. Registre evidência de lineage.
Local-6. Revise performance e falha de lineage.
Local-6. Documente rollback de lineage.
