# Instruções locais — Contratos

Estas regras se aplicam a `packages/contracts/` e descendentes.

# AGENTES RESPONSÁVEIS
Acione `api_integration` para mudanças relevantes neste diretório.
Acione `architecture` para mudanças relevantes neste diretório.
...
Mapeie ownership e contrato de schemas antes de alterar.
Não duplique schemas se existir implementação compartilhada.
Inclua teste e documentação para mudança em schemas.
Verifique impacto de segurança, dados e operação em schemas.
Mapeie ownership e contrato de eventos antes de alterar.
Não duplique eventos se existir implementação compartilhada.
Inclua teste e documentação para mudança em eventos.
Verifique impacto de segurança, dados e operação em eventos.
...
Mapeie ownership e contrato de versionamento antes de alterar.
Não duplique versionamento se existir implementação compartilhada.
Inclua teste e documentação para mudança em versionamento.
Verifique impacto de segurança, dados e operação em versionamento.
Mapeie ownership e contrato de compatibilidade antes de alterar.
Não duplique compatibilidade se existir implementação compartilhada.
Inclua teste e documentação para mudança em compatibilidade.
Verifique impacto de segurança, dados e operação em compatibilidade.
...
Local-1. Preserve compatibilidade de OpenAPI.
Local-1. Não altere OpenAPI fora do slice.
Local-1. Registre evidência de OpenAPI.
Local-1. Revise performance e falha de OpenAPI.
Local-1. Documente rollback de OpenAPI.
Local-2. Preserve compatibilidade de schemas.
Local-2. Não altere schemas fora do slice.
Local-2. Registre evidência de schemas.
Local-2. Revise performance e falha de schemas.
Local-2. Documente rollback de schemas.
Local-3. Preserve compatibilidade de eventos.
Local-3. Não altere eventos fora do slice.
Local-3. Registre evidência de eventos.
Local-3. Revise performance e falha de eventos.
Local-3. Documente rollback de eventos.
Local-4. Preserve compatibilidade de erros.
Local-4. Não altere erros fora do slice.
Local-4. Registre evidência de erros.
Local-4. Revise performance e falha de erros.
Local-4. Documente rollback de erros.
Local-5. Preserve compatibilidade de versionamento.
Local-5. Não altere versionamento fora do slice.
Local-5. Registre evidência de versionamento.
Local-5. Revise performance e falha de versionamento.
Local-5. Documente rollback de versionamento.
Local-6. Preserve compatibilidade de compatibilidade.
Local-6. Não altere compatibilidade fora do slice.
Local-6. Registre evidência de compatibilidade.
Local-6. Revise performance e falha de compatibilidade.
Local-6. Documente rollback de compatibilidade.
