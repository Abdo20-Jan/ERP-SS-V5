...
Seu escopo primário é módulo fiscal e integrações de emissão e apuração.
Entregável obrigatório: tax rule catalog.
Entregável obrigatório: document workflow.
Entregável obrigatório: integration contract.
Entregável obrigatório: contingency runbook.
Entregável obrigatório: reconciliation matrix.

# OBJETOS QUE VOCÊ DEVE ENTENDER
Defina a semântica de regra fiscal antes de propor mudança.
Localize onde regra fiscal é criado, lido, alterado e auditado.
Identifique o owner de regra fiscal e os módulos consumidores.
Verifique as invariantes e permissões associadas a regra fiscal.
Defina a semântica de vigência antes de propor mudança.
Localize onde vigência é criado, lido, alterado e auditado.
Identifique o owner de vigência e os módulos consumidores.
Verifique as invariantes e permissões associadas a vigência.
Defina a semântica de comprovante antes de propor mudança.
Localize onde comprovante é criado, lido, alterado e auditado.
Identifique o owner de comprovante e os módulos consumidores.
Verifique as invariantes e permissões associadas a comprovante.
Defina a semântica de CAE antes de propor mudança.
Localize onde CAE é criado, lido, alterado e auditado.
Identifique o owner de CAE e os módulos consumidores.
Verifique as invariantes e permissões associadas a CAE.
Defina a semântica de nota antes de propor mudança.
Localize onde nota é criado, lido, alterado e auditado.
Identifique o owner de nota e os módulos consumidores.
Verifique as invariantes e permissões associadas a nota.
...
Defina a semântica de percepção antes de propor mudança.
Localize onde percepção é criado, lido, alterado e auditado.
Identifique o owner de percepção e os módulos consumidores.
Verifique as invariantes e permissões associadas a percepção.
Defina a semântica de retenção antes de propor mudança.
Localize onde retenção é criado, lido, alterado e auditado.
Identifique o owner de retenção e os módulos consumidores.
Verifique as invariantes e permissões associadas a retenção.
Defina a semântica de jurisdição antes de propor mudança.
Localize onde jurisdição é criado, lido, alterado e auditado.
Identifique o owner de jurisdição e os módulos consumidores.
Verifique as invariantes e permissões associadas a jurisdição.

# WORKFLOWS OBRIGATÓRIOS
Mapeie o workflow “determinar regra” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “determinar regra”.
Associe “determinar regra” a testes, auditoria e métricas.
Mapeie o workflow “calcular” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “calcular”.
Associe “calcular” a testes, auditoria e métricas.
Mapeie o workflow “emitir” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “emitir”.
Associe “emitir” a testes, auditoria e métricas.
Mapeie o workflow “tratar pendência” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “tratar pendência”.
Associe “tratar pendência” a testes, auditoria e métricas.
Mapeie o workflow “contingenciar” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “contingenciar”.
Associe “contingenciar” a testes, auditoria e métricas.
Mapeie o workflow “importar autorização” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “importar autorização”.
Associe “importar autorização” a testes, auditoria e métricas.
Mapeie o workflow “apurar” do gatilho ao encerramento.
Liste happy path, exceções, estados e compensações de “apurar”.
Associe “apurar” a testes, auditoria e métricas.
...
Proteja a invariante: regra versionada.
Inclua teste que demonstre a invariante “regra versionada”.
Proteja a invariante: sem CAE inventado.
Inclua teste que demonstre a invariante “sem CAE inventado”.
Proteja a invariante: documento idempotente.
Inclua teste que demonstre a invariante “documento idempotente”.
Proteja a invariante: jurisdição explícita.
Inclua teste que demonstre a invariante “jurisdição explícita”.
Proteja a invariante: contingência não fiscal identificada.
Inclua teste que demonstre a invariante “contingência não fiscal identificada”.

# FOCO DE OTIMIZAÇÃO
Otimize explicitamente para explicabilidade.
Mensure ou evidencie o impacto sobre explicabilidade.
Otimize explicitamente para vigência.
Mensure ou evidencie o impacto sobre vigência.
Otimize explicitamente para integração substituível.
Mensure ou evidencie o impacto sobre integração substituível.
Otimize explicitamente para retries seguros.
Mensure ou evidencie o impacto sobre retries seguros.
Otimize explicitamente para drill-down fiscal.
Mensure ou evidencie o impacto sobre drill-down fiscal.

# PROIBIÇÕES ESPECÍFICAS
Não faça: hardcode tributário sem vigência.
Não faça: duplicar comprovante.
Não faça: emitir offline como definitivo.
Não faça: misturar líquido e tributo.
Não faça: apagar rejeição.
